...
public TextMeshProUGUI text;
  ...
  public GameObject[] soldiersRight1  = new GameObject[3];
  public GameObject[] soldiersRight2  = new GameObject[3];
  public GameObject[] soldiersLeft1 = new GameObject[3];
  public GameObject[] soldiersLeft2  = new GameObject[3];
  ...
  public bool IsMouseOverUI()
 {
    ...
    { 
      ...
      for(int i=0;i<3;i++)
      {
        ...
        if(soldiersRight1[i].GetComponent<Individual>().deadFlag == 1)
        soldiersRight1[i] = dummy;
        if(soldiersRight2[i].GetComponent<Individual>().deadFlag == 1)
        soldiersRight2[i] = dummy;
        if(soldiersLeft1[i].GetComponent<Individual>().deadFlag == 1)
        soldiersLeft1[i] = dummy;
         if(soldiersLeft2[i].GetComponent<Individual>().deadFlag == 1)
        soldiersLeft2[i] = dummy;
      }
  ...
  */
    ...
    { 
         ...
         soldiersLeft[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft[2].transform.localPosition,new Vector3(narrowLeftTargetX,soldiersLeft[2].transform.localPosition.y,cubeZ + 2f),transitionSpeed * Time.timeScale * Time.deltaTime);
            ...
            soldiersLeft[0].transform.localPosition = Vector3.MoveTowards(soldiersLeft[0].transform.localPosition,new Vector3(narrowLeftTargetX,soldiersLeft[0].transform.localPosition.y,cubeZ + 4f),transitionSpeed * Time.timeScale * Time.deltaTime);
             ...
             soldiersLeft1[0].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[0].transform.localPosition,new Vector3(-4f,soldiersLeft1[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft1[1].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[1].transform.localPosition,new Vector3(-4f,soldiersLeft1[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft1[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[2].transform.localPosition,new Vector3(-4f,soldiersLeft1[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);

             soldiersLeft2[0].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[0].transform.localPosition,new Vector3(-4f,soldiersLeft2[0].transform.localPosition.y,cubeZ + 4f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft2[1].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[1].transform.localPosition,new Vector3(-4f,soldiersLeft2[1].transform.localPosition.y,cubeZ + 3f ),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft2[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[2].transform.localPosition,new Vector3(-4f,soldiersLeft2[2].transform.localPosition.y,cubeZ + 2f ),transitionSpeed * Time.timeScale * Time.deltaTime);
            ...
            soldiersRight[1].transform.localPosition = Vector3.MoveTowards(soldiersRight[1].transform.localPosition,new Vector3(narrowRightTargetX,soldiersLeft[1].transform.localPosition.y,cubeZ + 3f),transitionSpeed * Time.timeScale * Time.deltaTime);
             ...
             soldiersRight1[0].transform.localPosition = Vector3.MoveTowards(soldiersRight1[0].transform.localPosition,new Vector3(-1f,soldiersRight1[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersRight1[1].transform.localPosition = Vector3.MoveTowards(soldiersRight1[1].transform.localPosition,new Vector3(-1f,soldiersRight1[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
             soldiersRight1[2].transform.localPosition = Vector3.MoveTowards(soldiersRight1[2].transform.localPosition,new Vector3(-1f,soldiersRight1[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);

              soldiersRight2[0].transform.localPosition = Vector3.MoveTowards(soldiersRight2[0].transform.localPosition,new Vector3(-1f,soldiersRight2[0].transform.localPosition.y,cubeZ + 4f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersRight2[1].transform.localPosition = Vector3.MoveTowards(soldiersRight2[1].transform.localPosition,new Vector3(-1f,soldiersRight2[1].transform.localPosition.y,cubeZ + 3f ),transitionSpeed * Time.timeScale * Time.deltaTime);
             soldiersRight2[2].transform.localPosition = Vector3.MoveTowards(soldiersRight2[2].transform.localPosition,new Vector3(-1f,soldiersRight2[2].transform.localPosition.y,cubeZ + 2f ),transitionSpeed * Time.timeScale * Time.deltaTime);
    ...
    void MidBack()
    {
            ...
            soldiersLeft[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft[2].transform.localPosition,new Vector3(wideLeftTargetX2,soldiersLeft[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);
             ...
             soldiersLeft1[0].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[0].transform.localPosition,new Vector3(wideLeftTargetX2-1f,soldiersLeft1[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft1[1].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[1].transform.localPosition,new Vector3(wideLeftTargetX2-1f,soldiersLeft1[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft1[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft1[2].transform.localPosition,new Vector3(wideLeftTargetX2-1f,soldiersLeft1[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);

             soldiersLeft2[0].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[0].transform.localPosition,new Vector3(wideLeftTargetX2-2f,soldiersLeft2[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft2[1].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[1].transform.localPosition,new Vector3(wideLeftTargetX2-2f,soldiersLeft2[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersLeft2[2].transform.localPosition = Vector3.MoveTowards(soldiersLeft2[2].transform.localPosition,new Vector3(wideLeftTargetX2-2f,soldiersLeft2[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);
            ...
            soldiersRight[1].transform.localPosition = Vector3.MoveTowards(soldiersRight[1].transform.localPosition,new Vector3(wideRightTargetX2,soldiersRight[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
             soldiersRight[2].transform.localPosition = Vector3.MoveTowards(soldiersRight[2].transform.localPosition,new Vector3(wideRightTargetX2,soldiersRight[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);
              ...
              soldiersRight1[0].transform.localPosition = Vector3.MoveTowards(soldiersRight1[0].transform.localPosition,new Vector3(wideRightTargetX2+1f,soldiersRight1[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersRight1[1].transform.localPosition = Vector3.MoveTowards(soldiersRight1[1].transform.localPosition,new Vector3(wideRightTargetX2+1f,soldiersRight1[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
             soldiersRight1[2].transform.localPosition = Vector3.MoveTowards(soldiersRight1[2].transform.localPosition,new Vector3(wideRightTargetX2+1f,soldiersRight1[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);
           
            soldiersRight2[0].transform.localPosition = Vector3.MoveTowards(soldiersRight2[0].transform.localPosition,new Vector3(wideRightTargetX2+2f,soldiersRight2[0].transform.localPosition.y,cubeZ - 1f),transitionSpeed * Time.timeScale * Time.deltaTime);
            soldiersRight2[1].transform.localPosition = Vector3.MoveTowards(soldiersRight2[1].transform.localPosition,new Vector3(wideRightTargetX2+2f,soldiersRight2[1].transform.localPosition.y,cubeZ ),transitionSpeed * Time.timeScale * Time.deltaTime);
             soldiersRight2[2].transform.localPosition = Vector3.MoveTowards(soldiersRight2[2].transform.localPosition,new Vector3(wideRightTargetX2+2f,soldiersRight2[2].transform.localPosition.y,cubeZ +1f ),transitionSpeed * Time.timeScale * Time.deltaTime);
